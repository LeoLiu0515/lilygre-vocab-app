/* ---------- storage & state ---------- */
// 考前衝刺版:獨立的 storage key,絕對不會碰到主 app 的 lgv_progress_v2。
...
// 這幾個也要獨立命名,不然萬一在衝刺版連了同步,會找到/蓋掉正式版的那份 Gist。
const SYNC_KEY = 'lgv_cram_sync_v1';
const GIST_FILENAME = 'lgv-cram-progress.json';
const GIST_DESC = 'LilyGRE Vocab CRAM Sync — 考前衝刺暫用,考完可以刪';
